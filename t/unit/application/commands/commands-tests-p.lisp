...
;;;; Closes the remaining nerimux/commands export-coverage gaps.
  ...
  `(it ,(string-downcase (symbol-name test-name))
     (let ((nerimux/buffer:*paste-buffers* nil))
       (let ((s (make-screen 20 5)))
         ...
         (,fn s)
         (expect (string= ,expected (nerimux/buffer:get-paste-buffer 0)))
...
(describe "commands-suite"
  ...
  (it "copy-mode-copy-selection-no-cancel-copies-and-clears-but-stays"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (%selecting-copy-mode-screen)))
        (nerimux/commands::copy-mode-copy-selection-no-cancel s)
        (expect (string= "abcde" (nerimux/buffer:get-paste-buffer 0)))
  ...
  (it "copy-mode-copy-selection-no-cancel-noop-outside-copy-mode"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (make-screen 20 5)))
        (feed s "abcde")
        (finishes (nerimux/commands::copy-mode-copy-selection-no-cancel s))
  ...
  (it "copy-mode-copy-selection-no-clear-copies-but-keeps-selection"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (%selecting-copy-mode-screen)))
        (nerimux/commands::copy-mode-copy-selection-no-clear s)
        (expect (string= "abcde" (nerimux/buffer:get-paste-buffer 0)))
  ...
  (it "copy-mode-copy-selection-no-clear-noop-outside-copy-mode"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (make-screen 20 5)))
        (feed s "abcde")
        (finishes (nerimux/commands::copy-mode-copy-selection-no-clear s))
        (expect (null nerimux/buffer:*paste-buffers*)))))
  ...
  (it "copy-mode-pipe-no-cancel-does-not-touch-paste-buffer"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (%selecting-copy-mode-screen)))
        (nerimux/commands::copy-mode-pipe-no-cancel s "")
        (expect (null nerimux/buffer:*paste-buffers*))
        (expect (screen-copy-selecting s) :to-be-falsy)
        (expect (screen-copy-mode-p s) :to-be-truthy))))
  ...
  (it "copy-mode-pipe-no-cancel-noop-outside-copy-mode"
    (let ((s (make-screen 20 5)))
      (feed s "abcde")
      (finishes (nerimux/commands::copy-mode-pipe-no-cancel s ""))
      (expect (screen-copy-mode-p s) :to-be-falsy)))
  ...
  (it "copy-mode-pipe-no-clear-keeps-selection"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (%selecting-copy-mode-screen)))
        (nerimux/commands::copy-mode-pipe-no-clear s "")
        (expect (null nerimux/buffer:*paste-buffers*))
        (expect (screen-copy-selecting s) :to-be-truthy)
        (expect (screen-copy-mode-p s) :to-be-truthy))))
  ...
  (it "copy-mode-pipe-and-cancel-exits-copy-mode"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (%selecting-copy-mode-screen)))
        (nerimux/commands::copy-mode-pipe-and-cancel s "")
        (expect (null nerimux/buffer:*paste-buffers*))
        (expect (screen-copy-mode-p s) :to-be-falsy))))
  ...
  (it "copy-mode-pipe-and-cancel-noop-outside-copy-mode"
    (let ((s (make-screen 20 5)))
      (feed s "abcde")
      (finishes (nerimux/commands::copy-mode-pipe-and-cancel s ""))
      (expect (screen-copy-mode-p s) :to-be-falsy)))
  ...
  (it "copy-mode-copy-pipe-no-clear-copies-and-keeps-selection"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (%selecting-copy-mode-screen)))
        (nerimux/commands::copy-mode-copy-pipe-no-clear s "")
        (expect (string= "abcde" (nerimux/buffer:get-paste-buffer 0)))
        (expect (screen-copy-selecting s) :to-be-truthy)
        (expect (screen-copy-mode-p s) :to-be-truthy))))
  ...
  (it "copy-mode-copy-pipe-line-copies-whole-line"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (make-screen 20 5)))
        ...
        (nerimux/commands::copy-mode-copy-pipe-line s "")
        (expect (string= "hello world" (nerimux/buffer:get-paste-buffer 0)))
        (expect (screen-copy-mode-p s) :to-be-truthy))))
  ...
  (it "copy-mode-copy-pipe-line-and-cancel-exits-copy-mode"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (make-screen 20 5)))
        ...
        (nerimux/commands::copy-mode-copy-pipe-line-and-cancel s "")
        (expect (string= "hello world" (nerimux/buffer:get-paste-buffer 0)))
        (expect (screen-copy-mode-p s) :to-be-falsy))))
  ...
  (it "copy-mode-rectangle-on-sets-rect-select-flag"
    (let ((s (copy-mode-screen)))
      ...
      (nerimux/commands::copy-mode-rectangle-on s)
  ...
  (it "copy-mode-rectangle-on-noop-outside-copy-mode"
    (let ((s (make-screen 20 5)))
      (finishes (nerimux/commands::copy-mode-rectangle-on s))
      (expect (screen-copy-rect-select-p s) :to-be-falsy)))
  ...
  (it "copy-mode-rectangle-off-clears-rect-select-flag"
    (let ((s (copy-mode-screen)))
      ...
      (nerimux/commands::copy-mode-rectangle-off s)
      (expect (screen-copy-rect-select-p s) :to-be-falsy)
  ...
  (it "copy-mode-rectangle-off-noop-outside-copy-mode"
    (let ((s (make-screen 20 5)))
      (finishes (nerimux/commands::copy-mode-rectangle-off s))
      (expect (screen-copy-rect-select-p s) :to-be-falsy)))
  ...
  (it "copy-mode-cursor-down-and-cancel-moves-cursor-mid-viewport"
    (let ((s (make-screen 20 5)))
      ...
      (nerimux/commands::copy-mode-enter s)
      (setf (screen-copy-cursor s) (cons 0 0))
      (nerimux/commands::copy-mode-cursor-down-and-cancel s)
  ...
  (it "copy-mode-cursor-down-and-cancel-noop-outside-copy-mode"
    (let ((s (make-screen 20 5)))
      (finishes (nerimux/commands::copy-mode-cursor-down-and-cancel s))
      (expect (screen-copy-mode-p s) :to-be-falsy)))
  ...
  (it "copy-mode-scroll-to-mouse-marks-screen-dirty"
    (let ((s (copy-mode-screen)))
      ...
      (nerimux/commands::copy-mode-scroll-to-mouse s)
  ...
  (define-copy-and-cancel-exit-test
    ...
    nerimux/commands::copy-mode-copy-end-of-line-and-cancel 6 "world")

  (define-copy-and-cancel-exit-test
      copy-mode-copy-line-and-cancel-copies-whole-line-and-exits
    nerimux/commands::copy-mode-copy-line-and-cancel 6 "hello world")
  ...
  (it "copy-mode-copy-end-of-line-and-cancel-noop-outside-copy-mode"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (make-screen 20 5)))
        (feed s "hello")
        (finishes (nerimux/commands::copy-mode-copy-end-of-line-and-cancel s))
        (expect (null nerimux/buffer:*paste-buffers*)))))
  ...
  (it "copy-mode-copy-line-and-cancel-noop-outside-copy-mode"
    (let ((nerimux/buffer:*paste-buffers* nil))
      (let ((s (make-screen 20 5)))
        (feed s "hello")
        (finishes (nerimux/commands::copy-mode-copy-line-and-cancel s))
        (expect (null nerimux/buffer:*paste-buffers*)))))
  ...
  (it "copy-mode-last-jump-nil-before-any-jump"
    (let ((nerimux/commands::*copy-mode-last-jump* nil))
      (expect (null nerimux/commands::*copy-mode-last-jump*))))
  ...
  (it "copy-mode-jump-forward-sets-last-jump"
    (let ((nerimux/commands::*copy-mode-last-jump* nil))
      (let ((s (make-screen 20 5)))
        ...
        (nerimux/commands::copy-mode-enter s)
        (setf (screen-copy-cursor s) (cons 0 0))
        (nerimux/commands::copy-mode-jump-forward s #\c)
        (expect nerimux/commands::*copy-mode-last-jump* :to-be-truthy)))))
