...
(describe "dispatch-suite"
  ...
  (it "dispatch-detach-returns-detach"
    (with-fake-session (s)
      (expect (eq :detach (nerimux::dispatch-command s :detach nil)))
  ...
  (it "dispatch-prefix-routes-binding"
    (with-fake-session (s)
      (expect (eq :detach (nerimux::dispatch-prefix-command s (char-code #\d))))))
  ...
  (it "prefix-q-exits-copy-mode"
    (with-fake-session (s)
      ...
      (nerimux::dispatch-prefix-command s (char-code #\q))
