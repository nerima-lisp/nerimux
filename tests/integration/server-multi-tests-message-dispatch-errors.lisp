  ...
  (let* ((organization
         ...
         (repository
          (nerimux/workspace-model:make-repository :id
                                                   ...
                                                   organization
                                                   :specification
                                                   "github.com/team-errors/repo-errors"))
         (worktree
...
(defun %worktree-message-seen-p (conn message)
  (find message (nerimux::client-conn-message-log conn) :test #'string=))
                                 ...
                                 (multiple-value-bind (repository worktree conn) 
                                   ...
                                   (let* ((nerimux::*clients* (list conn))
                                     ...
                                     (unwind-protect 
                                         (progn
                                           (setf (fdefinition
                                                  'nerimux/vcs:vcs-package-available-p) (lambda 
                                                                                            ()
                                                                                          t))
                                           (nerimux::%set-client-selected-tree-object
                                            ...
                                            repository)
                                           (setf (fdefinition
                                                  'nerimux/vcs:create-worktree-async) (lambda 
                                                                                          (received-repository
                                                                                           &key
                                                                                           branch
                                                                                           path
                                           ...
                                           (setf (fdefinition
                                                  'nerimux/vcs:lock-worktree-async) (lambda 
                                                                                        (received-worktree
                                                                                         &key
                                                                                         reason
                                                                                         on-complete
                                           ...
                                           (setf (fdefinition
                                                  'nerimux/vcs:unlock-worktree-async) (lambda 
                                                                                          (received-worktree
                                                                                           &key
                                                                                           on-complete
                                                                                           on-error
                                       ...
                                       (setf (fdefinition
                                             ...
                                             (fdefinition
                                              'nerimux/vcs:create-worktree-async) create-fn
                                             (fdefinition
                                              'nerimux/vcs:delete-worktree-async) delete-fn
                                             (fdefinition
                                              'nerimux/vcs:lock-worktree-async) lock-fn
                                             (fdefinition
                                              'nerimux/vcs:unlock-worktree-async) unlock-fn
                                             (fdefinition
                                              'nerimux/vcs:prune-worktrees-async) prune-fn))))))
                                   ...
                                   (let* ((nerimux::*clients* (list conn))
                                     ...
                                     (unwind-protect 
                                         (progn
                                           ...
                                           (expect
                                            (eq worktree
                                                (nerimux::client-conn-selected-worktree
                                                 conn)))
                                           (expect
                                            (%worktree-message-seen-p conn
                                                                      "worktree created"))
                                   ...
                                   (let* ((nerimux::*clients* (list conn))
                                     ...
                                     (unwind-protect 
                                         (progn
                                           ...
                                           (expect
                                            (%worktree-message-seen-p conn
                                                                      "worktree unlock requires a worktree"))
                                           (nerimux::%set-client-selected-tree-object
                                            conn
                                            repository)
                                           (nerimux::%client-create-worktree
                                           ...
                                           (expect
                                            (%worktree-message-seen-p conn
                                                                      "worktree create requires a branch"))
                                           (setf (fdefinition
                                                  'nerimux/vcs:vcs-package-available-p) (lambda 
                                                                                            ()
                                                                                          nil))
