;;;; Copy-mode lifecycle: the cl-dataflow-kit state machine and read-model.
;;;;
...
(defun copy-mode-lifecycle-machine ()
  ...
  (cl-dataflow-kit:make-state-machine
   ...
   :transitions
   (list
    (cl-dataflow-kit:make-transition "normal"    "enter"            "copy-mode")
    (cl-dataflow-kit:make-transition "copy-mode" "exit"              "normal")
    (cl-dataflow-kit:make-transition "copy-mode" "begin-selection"   "selecting")
    (cl-dataflow-kit:make-transition "selecting" "cancel-selection"  "copy-mode")
    (cl-dataflow-kit:make-transition "selecting" "exit"              "normal")
    (cl-dataflow-kit:make-transition "selecting" "yank"              "normal"))))
...
(defun copy-mode-lifecycle-states ()
  ...
  (cl-dataflow-kit:state-machine-states (copy-mode-lifecycle-machine)))

(defun copy-mode-lifecycle-events ()
  "Return every event name the copy-mode lifecycle machine accepts."
  (cl-dataflow-kit:state-machine-event-types (copy-mode-lifecycle-machine)))
...
(defun copy-mode-lifecycle-terminal-states ()
  ...
  (cl-dataflow-kit:state-machine-terminal-states (copy-mode-lifecycle-machine)))
...
(defun copy-mode-lifecycle-unreachable-states ()
  ...
  (cl-dataflow-kit:state-machine-unreachable-states (copy-mode-lifecycle-machine)))
...
(defun copy-mode-lifecycle-deterministic-p ()
  ...
  (cl-dataflow-kit:state-machine-deterministic-p (copy-mode-lifecycle-machine)))

(defun copy-mode-lifecycle->dot ()
  "Render the copy-mode lifecycle machine as Graphviz DOT, for `dot -Tsvg`
   or documentation."
  (cl-dataflow-kit:state-machine->dot (copy-mode-lifecycle-machine) :name "copy_mode"))
...
(defun copy-mode-lifecycle->mermaid ()
  ...
  (cl-dataflow-kit:state-machine->mermaid (copy-mode-lifecycle-machine)))
