...
(define-key-rules %handle-client-ui-key-payload
                  ...
                  (:let ((view (client-conn-view conn))
                         (menu-view-p (member view '(:repolist :status)))))
                  ...
                  ((and (eq view :status) (%client-key-p payload #\v))
                  ...
                  ((and (eq view :status) (%client-key-p payload #\!))
                   (%open-client-transient conn #\!))
                  ((and menu-view-p (%client-key-p payload #\P))
                   (%open-client-transient conn #\P))
                  ((and menu-view-p (%client-key-p payload #\F))
                   (%open-client-transient conn #\F))
                  ((and menu-view-p (%client-key-p payload #\b))
                   (%open-client-transient conn #\b))
                  ((and menu-view-p (%client-key-p payload #\m))
                   (%open-client-transient conn #\m))
                  ((and menu-view-p (%client-key-p payload #\r))
                   (%open-client-transient conn #\r))
                  ((and menu-view-p (%client-key-p payload #\z))
                   (%open-client-transient conn #\z))
                  ((and menu-view-p (%client-key-p payload #\l))
                   (%open-client-transient conn #\l))
                  ((and menu-view-p (%client-key-p payload #\d))
                   (%open-client-transient conn #\d))
                  ((and menu-view-p (%client-key-p payload #\f))
                   (%open-client-transient conn #\f))
                  ((and menu-view-p (%client-key-p payload #\X))
                   (%open-client-transient conn #\X))
                  ((and menu-view-p (%client-key-p payload #\w))
