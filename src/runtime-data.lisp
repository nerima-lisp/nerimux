...
(defvar *dirty* t "Whether the terminal needs another render pass.")
(defvar *running* t "Whether the main event loop should continue processing input.")
(defvar *resize-pending* nil "Whether a SIGWINCH resize is waiting to be applied.")
(defvar *term-rows* 24 "Current terminal height in rows.")
(defvar *term-cols* 80 "Current terminal width in columns.")
(defvar *server-sessions* nil "Sessions currently owned by the server runtime.")
