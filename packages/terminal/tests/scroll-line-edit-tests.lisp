               ...
               (destructuring-bind (width height) (case-option options :screen)
                 `(it ,(string-downcase (symbol-name name))
                      (with-screen (s ,width ,height)
                                   ...
                                   (feed s
                                         (csi ,(case-option options :params)
...
(describe "terminal-suite/delete-insert-chars"
     ...
     blanking the two vacated cells at the end of the line."
            ...
            :assertions
            ((:cells
              ((#\c 0 "col0 should be 'c'") (#\d 1 "col1 should be 'd'")
           ...
           (dch-at-midline
            ...
            #\P
            :assertions
            ((:row-prefix "acde" 4 "expected 'acde', got ~S")
           ...
           (dch-default-param-deletes-one
            ...
            #\P
            :assertions
            ((:row-prefix "bcde" 4 "expected 'bcde', got ~S")))
     ...
     chars shifted past the right margin are lost."
            ...
            :assertions
            ((:cells
              ((#\Space 0 "col0 should be blank gap")
           ...
           (ich-at-midline
            ...
            :assertions
            ((:cells
              ((#\a 0 "col0 unchanged 'a'") (#\b 1 "col1 unchanged 'b'")
                                            (#\Space 2
                                                     "col2 should be the inserted blank")
